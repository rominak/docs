...
### Step 3: Prompting Your MCP Client

Once connected, you can prompt your client to access a design node in two ways:

1.  **Selection-based:** Select a frame or layer in the Figma desktop app and prompt your client to implement it.
2.  **Link-based:** Copy the link to a frame or layer and ask your client to implement the design from the URL.
